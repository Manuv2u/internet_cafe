...
$errors = [];
$message = "";
$name = $address = $mobile_number = $email = ""; // Initialize
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($errors)) {
        ...
        if ($stmt->execute()) {
            ...
            // Clear form values
            $name = $address = $mobile_number = $email = "";
        } else {
...
<div class="form-container">
    ...
    <form method="POST" novalidate>
        <label>Name:</label>
        <input type="text" name="name" value="<?= htmlspecialchars($name) ?>" required onblur="capitalizeName(this)">
        ...
        <input type="text" name="mobile_number" value="<?= htmlspecialchars($mobile_number) ?>" required>
